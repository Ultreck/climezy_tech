          ...
          <div className="bg-transparent text-white rounded-xl p-6 mb-6">
            ...
            <div className="text ">
              <div className="items-center w-60 h-10 flex px-2 z-30  gap-10">
                ...
                <span className="text flex items-center gap-1">{formatTime(weatherData?.sys?.sunrise)} <TbSunrise className="text-orange-500" /></span>
                </p>
                <p className="text">
                <span className="text">Sunset</span>
                <span className="text flex items-center gap-1">{formatTime(weatherData?.sys?.sunset)} <FiSunset className="text-orange-500" /></span>
                </p>
              </div>
            </div>
