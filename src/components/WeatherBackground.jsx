  ...
  useEffect(() => {
    ...
    switch(weatherCondition.toLowerCase()) {
      case 'clear':
        ...
        if (Math.random() > 0.5) {
          const newStars = Array(15).fill().map((_, i) => ({
            id: i,
      ...
      case 'clouds':
      case 'broken clouds':
        const newClouds = Array(5).fill().map((_, i) => ({
          id: i,
          left: `${Math.random() * 100}%`,
          top: `${Math.random() * 30}%`,
        ...
        break;
      case 'rain':
        setClouds(Array(4).fill().map((_, i) => ({
          id: i,
          left: `${Math.random() * 100}%`,
          top: `${Math.random() * 30}%`,
          size: `${Math.random() * 10 + 20}px`,
        ...
        const newRain = Array(60).fill().map((_, i) => ({
          id: i,
          left: `${Math.random() * 100}%`,
          top: `${Math.random() * 100}%`,
        ...
        break;
      case 'snow':
        setClouds(Array(3).fill().map((_, i) => ({
          id: i,
          left: `${Math.random() * 100}%`,
          top: `${Math.random() * 30}%`,
          size: `${Math.random() * 10 + 20}px`,
        ...
        const newSnow = Array(30).fill().map((_, i) => ({
          id: i,
          left: `${Math.random() * 100}%`,
          top: `${Math.random() * 100}%`,
      ...
      default:
        setSun(true);
        const defaultClouds = Array(3).fill().map((_, i) => ({
          id: i,
          left: `${Math.random() * 100}%`,
          top: `${Math.random() * 30}%`,
          size: `${Math.random() * 10 + 20}px`,
  ...
  return (
    <div className={`relative w-full  max-w-3xl h-56 shadow-lg mx-auto rounded-xl overflow-hidden ${getBackgroundGradient()}`}>
      ...
      {clouds.map(cloud => (
        <div
          key={cloud.id}
          className={`absolute rounded-full ${cloud.dark ? 'bg-gray-600' : 'bg-white'} shadow-lg`}
          style={{
            left: cloud.left,
            top: cloud.top,
            width: cloud.size,
